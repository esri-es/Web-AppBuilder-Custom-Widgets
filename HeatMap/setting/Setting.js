  ...
  function(
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(config) {
        ...
        if (options && options.featureServiceUrl) {
          this.featureServiceUrl.set('value', options.featureServiceUrl);
        }
      },
      ...
      getConfig: function() {
        ...
        if (!this.featureServiceUrl.get('value')) {
        ...
        options.featureServiceUrl = this.featureServiceUrl.get("value");
