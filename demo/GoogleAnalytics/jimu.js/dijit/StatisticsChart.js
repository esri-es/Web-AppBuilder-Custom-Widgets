      ...
      */
      ...
      _getHighLightFillSymbol: function(featureLayer, feature, isSelectedFeature){
        ...
        if(!currentSymbol && renderer){
          currentSymbol = renderer.getSymbol(feature);
        }
      ...
      _getSerieData:function(item, num){
        ...
        if(item.borderColor){
          dataObj.itemStyle.normal.borderColor = item.borderColor;
          dataObj.itemStyle.emphasis.borderColor = item.borderColor;
        }
        return dataObj;
      },
