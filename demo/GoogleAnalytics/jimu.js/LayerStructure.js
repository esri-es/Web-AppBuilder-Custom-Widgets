define([
...
], function(declare, array, lang, topic, on, Evented, LayerNode, LayerInfos) {
  var clazz = declare([Evented], {
    ...
    _init: function() {
      this._layerInfos.traversalAll(lang.hitch(this, function(layerInfo) {
        if(!layerInfo._adaptor) {
          layerInfo._adaptor = new LayerNode(layerInfo);
        }
      }));
    },
    ...
    _bindEvents: function() {
      ...
      handle = topic.subscribe('layerInfos/layerInfoFactory/create',
        lang.hitch(this, this._newLayerInfoWasAdded));
    ...
    _newLayerInfoWasAdded: function(newLayerInfo) {
      if(!newLayerInfo._adaptor) {
        newLayerInfo._adaptor = new LayerNode(newLayerInfo);
      }
    },
