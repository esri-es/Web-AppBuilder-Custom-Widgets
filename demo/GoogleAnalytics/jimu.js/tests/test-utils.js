...
function(doh, utils, WidgetManager, query) {
	...
	function testMerge7() {
		...
		function testReCreateObject1(){
			doh.assertEqual({}, utils.reCreateObject({}));
		},

		function testReCreateObject2(){
			doh.assertEqual({a: 1}, utils.reCreateObject({a: 1}));
		},

		function testReCreateObject3(){
			doh.assertEqual({a: {b: 1}}, utils.reCreateObject({a: {b: 1}}));
		},

		function testReCreateObject4(){
			doh.assertEqual([], utils.reCreateObject([]));
		},

		function testReCreateObject5(){
			doh.assertEqual([1, 2], utils.reCreateObject([1, 2]));
		},

		function testReCreateObject6(){
			doh.assertEqual([{a: 1}, {b: 2}], utils.reCreateObject([{a: 1}, {b: 2}]));
		},

		function testReCreateObject7(){
			doh.assertEqual([{a: [1, 2]}, {b: 2}], utils.reCreateObject([{a: [1, 2]}, {b: 2}]));
		},

		function testReCreateObject8(){
			doh.assertEqual([[1, 2], {b: 2}], utils.reCreateObject([[1, 2], {b: 2}]));
		},

		function testReCreateObject9(){
			...
			doh.assertEqual(o, utils.reCreateObject(o));
		},

		function testReCreateObject10(){
			doh.assertEqual({a: null}, utils.reCreateObject({a: null}));
		},

		function testAddRelativePathInCss1(){
			var css = 'background: url(images/unfold01.png) center no-repeat;';
			var css2 = utils.addRelativePathInCss(css, 'mypath1/');
			doh.assertEqual('background: url(mypath1/images/unfold01.png) center no-repeat;', css2);
		},

		function testAddRelativePathInCss2(){
			var css = 'background: url(images/unfold01.png) center no-repeat;background: url(images/unfold02.png)';
			var css2 = utils.addRelativePathInCss(css, 'mypath1');
			doh.assertEqual('background: url(mypath1/images/unfold01.png) center no-repeat;background: url(mypath1/images/unfold02.png)', css2);
		},

		function testAddRelativePathInCss3(){
			var css = 'background: url("images/unfold01.png") center no-repeat;background: url(./images/unfold02.png)';
			var css2 = utils.addRelativePathInCss(css, 'mypath1');
			doh.assertEqual('background: url("mypath1/images/unfold01.png") center no-repeat;background: url(mypath1/./images/unfold02.png)', css2);
		},

		function testAddRelativePathInCss4(){
			//same url, two times
			var css = 'background: url("images/unfold01.png") center no-repeat;background: url(images/unfold01.png)';
			var css2 = utils.addRelativePathInCss(css, 'mypath1');
			doh.assertEqual('background: url("mypath1/images/unfold01.png") center no-repeat;background: url(mypath1/images/unfold01.png)', css2);
		}	,

		function testAddRelativePathInCss5(){
			//same url, two times
			var css = 'background: url(images/unfold01.png) center no-repeat;background: url(images/unfold01.png)';
			var css2 = utils.addRelativePathInCss(css, 'mypath1');
			doh.assertEqual('background: url(mypath1/images/unfold01.png) center no-repeat;background: url(mypath1/images/unfold01.png)', css2);
		...
		function testAddRelativePathInCss6(){
			//relative is empty
			var css = 'background: url(images/unfold01.png) center no-repeat;background: url(images/unfold01.png)';
			var css2 = utils.addRelativePathInCss(css, '');
			doh.assertEqual('background: url(images/unfold01.png) center no-repeat;background: url(images/unfold01.png)', css2);
		}	
